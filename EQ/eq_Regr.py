...
class Regr_diagn(eq_base.init_eq):
    ...
    def run_diagnostic(self,array_of_cook):
        ...
        #plt.savefig('my_plot4.tif', dpi = 300, bbox_inches='tight')
        plt.show()
        ...
        #plt.savefig('my_plot5.tif', dpi = 300, bbox_inches='tight')
        plt.show()
    def influential_points(self):
        ...
        #plt.savefig('my_plot50.tif', dpi = 300, bbox_inches='tight')
        plt.show()
        ...
        #plt.savefig('my_plot51.tif', dpi = 300, bbox_inches='tight')
        plt.show()        
