...
class Radar_plots:      
    ...
    def radar_plot(self,input_data,color_radar='red',title_string=''):  
        ...
        #plt.savefig('my_plot111.tif', dpi = 300, bbox_inches='tight')
        plt.show()
    def radar_plots(self,input_data1,input_data2,color_radar1='red',color_radar2='blue',
        ...
        #plt.savefig('my_plot112.tif', dpi = 300, bbox_inches='tight')
        plt.show()
    def polar_bars(self,input_data1,input_data2,color_radar1='orange',color_radar2='blue',
        ...
        if len(sup_title)>0:
            plt.title(sup_title)
        plt.legend(loc="best")
        #plt.savefig('my_plot115.tif', dpi = 300, bbox_inches='tight')
        plt.show()
